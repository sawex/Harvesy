...
<body <?php body_class(); ?>>
	<img src="images/logo/logopng-2-01-invert.png" alt="Harvesy sudio logo" class="main-header__logo-img logo__image loader-logo">
		...
		<div class="container-fluid desktop-header">
			<div class="row">
				<nav class="main-header__navbar">
					...
					?>
					<!-- <ul class="main-header__nav-menu loader-content-hidden">
						<li class="main-header__nav-list-item">
							<a href="#" class="main-header__nav-link">Photo</a> 
						</li>
						<li class="main-header__nav-list-item">
							<a href="#" class="main-header__nav-link">Video</a> 
						</li>
						<li class="main-header__nav-list-item">
							<a href="#" class="main-header__nav-link">About us</a> 
						</li>
						<li class="main-header__nav-list-item">
							<a href="#" class="main-header__nav-link">Contacts</a> 
						</li>
						<li class="main-header__nav-list-item">
							<a href="#" class="main-header__nav-link booking">Booking</a> 
						</li>
					</ul> -->
          ...
          ?>
					...
					<!-- <ul class="main-header__social-menu loader-content-hidden">
						<li class="main-header__social-menu-item">
							<a href="#" class="main-header__social-link">
